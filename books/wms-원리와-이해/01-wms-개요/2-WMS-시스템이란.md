...
![생산 공장·WMS·ERP 하위 시스템·고객 시스템 사이의 재고 이동과 정보 연계 순서](./assets/03-erp-wms-연계.svg)
...
- 로케이션·LOT·실시간 재고관리는 [WMS의 주요 특징](./3-WMS의-주요-특징.md)에서 이어진다.
- 이 절의 생산·영업·회계 연계가 실제로 주고받는 데이터는 [ERP 및 OMS 인터페이스](../10-인터페이스/3-인터페이스-정보.md#가-erp-및-oms-인터페이스)에서 구체적으로 확인할 수 있다.
