...
- 프리로케이션 개념과의 관계는 [프리로케이션 재고 방식](../02-wms-주요-프로세스/4-할당과-피킹-출고.md#먼저--프리로케이션-재고-방식이란)을 참고한다.
- 재고보충의 개관은 [재고보충](../02-wms-주요-프로세스/3-재고이동과-재고보충.md#④-재고보충-replenishment)에 있다.
