...
- 권한의 대상이 되는 **창고 · 고객사(화주) · 제품**은 모두 [3장 기준정보](../3-기준정보/README.md)에서 정의한 코드들이다.
- **여러 고객사를 한 WMS에서 서비스한다**는 전제는 [고객사 기준정보](../3-기준정보/3-거래처관련-기준정보.md#가-고객사)에서 나왔다. 그 전제가 곧 이 장의 필요성이 된다.
