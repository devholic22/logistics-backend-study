...
![WMS 입고 프로세스의 다섯 단계](assets/01-입고-프로세스.svg)
...
![입고 과정의 물리적 이동과 정보 흐름](assets/02-입고-물리-정보-흐름.svg)
...
- 이 장은 [2장의 입고와 적치](../02-wms-주요-프로세스/2-입고와-적치.md)를 상세히 펼친 것이다. 2장은 전체 프로세스 안에서의 위치를, 4장은 각 단계의 실제 동작을 다룬다.
- 입고존·보관존의 정의는 [주요 존의 종류](../02-wms-주요-프로세스/1-로케이션과-존.md#주요-존의-종류)에 있다.
- 입고예정부터 적치확정까지의 상태와 처리시간은 [가시성의 실시간 추적과 KPI](../11-가시성/3-Visibility-추진단계.md#나-2단계--데이터-분석--오류통보)를 만드는 원천 데이터다.
