...
- **무선 RF는 ③부터 쓴다.** ①②는 시스템에 데이터를 넣는 일이라 현장 장비가 필요 없다. [입고 프로세스에서 ①이 RF 없이 진행되던 것](../04-입고-프로세스/README.md#주요-입고-프로세스)과 같은 패턴이다.
...
- [재고이동 — ③④와 ⑦이 쓰는 그 기능](../02-wms-주요-프로세스/3-재고이동과-재고보충.md)
