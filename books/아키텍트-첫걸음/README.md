...
- [부하·확장성 테스트](./5-품질-보증과-테스트/3-성능-테스트.md)는 [B마트 OMS가 피크 주문과 출고 시각 계산을 시뮬레이션한 사례](../요즘-우아한-백엔드-개발/11-b마트-oms의-물류주문관리를-통한-출고-최적화/README.md)에서 실제 물류 처리량 검증으로 이어진다.
