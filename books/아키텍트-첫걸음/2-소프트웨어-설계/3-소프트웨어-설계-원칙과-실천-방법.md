...
![OCP 적용 후 클래스 관계](3-소프트웨어-설계-원칙과-실천-방법/assets/01-ocp-클래스-관계.svg)
...
![DIP 적용 전 컴포넌트 의존성](3-소프트웨어-설계-원칙과-실천-방법/assets/02-dip-적용-전.svg)
...
![DIP 적용 후 컴포넌트 의존성](3-소프트웨어-설계-원칙과-실천-방법/assets/03-dip-적용-후.svg)
...
![주문 등록 서비스의 프로세스 로직](3-소프트웨어-설계-원칙과-실천-방법/assets/04-주문-프로세스-로직.svg)
...
![컴포넌트 내부와 외부 의존 관계](3-소프트웨어-설계-원칙과-실천-방법/assets/05-컴포넌트-의존관계.svg)
